...
const DashboardInfo: React.FC = () => {
	...
	return (
		<>
			<Button className="refresh-button" shape="round" onClick={refreshDashboardList}>
				Refresh
			</Button>
			<Divider />
			<Row gutter={[gutters, vgutters]}>
				...
				<Col key={4} span={24 / colCount}>
					<div className="card border-secondary">
						...
						<div className="card-body">
							<p>GitHub Address:<a target="_blank" href="https://github.com/jingyuan-git/system-monitoring-tools"> System Monitoring Tool</a></p>
							<p>GitHub Stars: <a href="https://github.com/jingyuan-git/system-monitoring-tools/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/jingyuan-git/system-monitoring-tools?style=flat-square" /></a></p>
							<p>GitHub Forks: <a href="https://github.com/jingyuan-git/system-monitoring-tools/network"><img alt="GitHub forks" src="https://img.shields.io/github/forks/jingyuan-git/system-monitoring-tools?style=flat-square" /></a></p>
						</div>
					</div>
				</Col>
			</Row>
